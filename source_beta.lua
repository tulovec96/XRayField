...
local RayfieldLibrary = {
	...
	Theme = {
		ModernDark = {
			...
			TabBackgroundHover = Color3.fromRGB(45, 45, 50),
			TabBackgroundSelected = Color3.fromRGB(65, 135, 245),
			...
			SliderProgress = Color3.fromRGB(65, 135, 245),
			SliderStroke = Color3.fromRGB(60, 60, 70),

			ToggleBackground = Color3.fromRGB(40, 40, 45),
			ToggleEnabled = Color3.fromRGB(65, 135, 245),
			ToggleDisabled = Color3.fromRGB(80, 80, 90),
			ToggleEnabledStroke = Color3.fromRGB(85, 155, 255),
			ToggleDisabledStroke = Color3.fromRGB(100, 100, 110),
			ToggleEnabledOuterStroke = Color3.fromRGB(45, 115, 225),
		...
		ModernLight = {
			...
			TabBackground = Color3.fromRGB(240, 240, 245),
			TabBackgroundHover = Color3.fromRGB(230, 230, 235),
			TabBackgroundSelected = Color3.fromRGB(65, 135, 245),
			...
			SecondaryElementBackground = Color3.fromRGB(245, 245, 250),
			ElementStroke = Color3.fromRGB(230, 230, 235),
			SecondaryElementStroke = Color3.fromRGB(225, 225, 230),

			SliderBackground = Color3.fromRGB(230, 230, 235),
			SliderProgress = Color3.fromRGB(65, 135, 245),
			SliderStroke = Color3.fromRGB(210, 210, 220),

			ToggleBackground = Color3.fromRGB(240, 240, 245),
			ToggleEnabled = Color3.fromRGB(65, 135, 245),
			ToggleDisabled = Color3.fromRGB(180, 180, 190),
			ToggleEnabledStroke = Color3.fromRGB(85, 155, 255),
			ToggleDisabledStroke = Color3.fromRGB(160, 160, 170),
			ToggleEnabledOuterStroke = Color3.fromRGB(45, 115, 225),
			ToggleDisabledOuterStroke = Color3.fromRGB(150, 150, 160),

			DropdownSelected = Color3.fromRGB(245, 245, 250),
			DropdownUnselected = Color3.fromRGB(255, 255, 255),

			InputBackground = Color3.fromRGB(250, 250, 255),
			InputStroke = Color3.fromRGB(220, 220, 230),
			PlaceholderColor = Color3.fromRGB(160, 160, 170),

			Accent = Color3.fromRGB(65, 135, 245),
			Success = Color3.fromRGB(75, 180, 90),
			Warning = Color3.fromRGB(235, 160, 50),
		...
		Cyber = {
			...
			Topbar = Color3.fromRGB(25, 30, 45),
			Shadow = Color3.fromRGB(10, 15, 25),

			NotificationBackground = Color3.fromRGB(20, 25, 40),
			NotificationActionsBackground = Color3.fromRGB(35, 40, 60),

			TabBackground = Color3.fromRGB(30, 35, 50),
			TabBackgroundHover = Color3.fromRGB(40, 45, 65),
			TabBackgroundSelected = Color3.fromRGB(0, 200, 255),
			TabTextColor = Color3.fromRGB(180, 200, 230),
			SelectedTabTextColor = Color3.fromRGB(15, 25, 40),

			ElementBackground = Color3.fromRGB(25, 30, 45),
			ElementBackgroundHover = Color3.fromRGB(35, 40, 60),
			SecondaryElementBackground = Color3.fromRGB(20, 25, 40),
			ElementStroke = Color3.fromRGB(50, 100, 150),
			SecondaryElementStroke = Color3.fromRGB(40, 80, 120),

			SliderBackground = Color3.fromRGB(30, 60, 90),
			SliderProgress = Color3.fromRGB(0, 180, 255),
			SliderStroke = Color3.fromRGB(50, 120, 180),

			ToggleBackground = Color3.fromRGB(30, 40, 60),
			...
			ToggleDisabledStroke = Color3.fromRGB(80, 90, 110),
			ToggleEnabledOuterStroke = Color3.fromRGB(0, 150, 220),
			ToggleDisabledOuterStroke = Color3.fromRGB(50, 60, 80),

			DropdownSelected = Color3.fromRGB(40, 50, 75),
			DropdownUnselected = Color3.fromRGB(30, 40, 60),

			InputBackground = Color3.fromRGB(25, 35, 55),
			InputStroke = Color3.fromRGB(60, 100, 140),
			PlaceholderColor = Color3.fromRGB(120, 150, 180),
		...
		Ocean = {
			...
			TextSecondary = Color3.fromRGB(180, 200, 200),

			Background = Color3.fromRGB(20, 30, 30),
			BackgroundSecondary = Color3.fromRGB(25, 35, 35),
			...
			TabBackgroundHover = Color3.fromRGB(50, 70, 70),
		...
		AmberGlow = {
			...
			BackgroundSecondary = Color3.fromRGB(50, 35, 25),
			...
			TabBackgroundHover = Color3.fromRGB(85, 60, 45),
			...
			Success = Color3.fromRGB(160, 200, 80),
			Warning = Color3.fromRGB(255, 180, 60),
			Error = Color3.fromRGB(235, 80, 80)
		},
		...
		Light = {
			...
			TabBackgroundHover = Color3.fromRGB(225, 225, 225),
		...
		Amethyst = {
			...
			BackgroundSecondary = Color3.fromRGB(35, 25, 45),
			...
			TabBackgroundHover = Color3.fromRGB(70, 50, 90),
		...
		Green = {
			...
			TextSecondary = Color3.fromRGB(60, 90, 60),

			Background = Color3.fromRGB(235, 245, 235),
			BackgroundSecondary = Color3.fromRGB(225, 235, 225),
			...
			TabBackgroundHover = Color3.fromRGB(205, 225, 205),
			...
			Accent = Color3.fromRGB(60, 130, 60),
			Success = Color3.fromRGB(85, 200, 100),
			Warning = Color3.fromRGB(255, 180, 60),
			Error = Color3.fromRGB(235, 80, 80)
		},
		...
		Bloom = {
			...
			TextSecondary = Color3.fromRGB(100, 70, 80),

			Background = Color3.fromRGB(255, 240, 245),
			BackgroundSecondary = Color3.fromRGB(250, 235, 240),
			...
			TabBackgroundHover = Color3.fromRGB(230, 200, 210),
		...
		DarkBlue = {
			...
			TabBackgroundHover = Color3.fromRGB(45, 50, 55),
		...
		Serenity = {
			...
			TextSecondary = Color3.fromRGB(100, 105, 110),

			Background = Color3.fromRGB(240, 245, 250),
			BackgroundSecondary = Color3.fromRGB(235, 240, 245),
			...
			TabBackgroundHover = Color3.fromRGB(190, 200, 210),
...
local SelectedTheme = RayfieldLibrary.Theme.ModernDark

local function ChangeTheme(Theme)
	if typeof(Theme) == 'string' then
		SelectedTheme = RayfieldLibrary.Theme[Theme] or RayfieldLibrary.Theme.ModernDark
	...
	Main.Search.BackgroundColor3 = SelectedTheme.BackgroundSecondary
	Main.Search.Shadow.ImageColor3 = SelectedTheme.Shadow
	Main.Search.Search.ImageColor3 = SelectedTheme.TextSecondary
	...
	-- Modern text styling with better fonts
	for _, text in ipairs(Rayfield:GetDescendants()) do
		if text.Parent.Parent ~= Notifications then
			if text:IsA('TextLabel') or text:IsA('TextBox') then 
				text.TextColor3 = SelectedTheme.TextColor
				-- Apply modern fonts
				if text:FindFirstAncestor("Topbar") then
					text.Font = Enum.Font.GothamSemibold
				elseif text.Name == "Title" or text.Name == "Selected" then
					text.Font = Enum.Font.GothamSemibold
				else
...
function RayfieldLibrary:Notify(data)
	task.spawn(function()
		...
		newNotification.UIStroke.Color = SelectedTheme.Accent
		newNotification.UIStroke.Thickness = 1
		
		-- Set Data with modern typography
		newNotification.Title.Text = data.Title or "Notification"
		newNotification.Title.TextColor3 = SelectedTheme.TextColor
		newNotification.Title.Font = Enum.Font.GothamSemibold
		
		newNotification.Description.Text = data.Content or "No content provided"
		newNotification.Description.TextColor3 = SelectedTheme.TextSecondary
		newNotification.Description.Font = Enum.Font.Gotham
		...
		if data.Image then
			if typeof(data.Image) == 'string' and Icons then
				...
				newNotification.Icon.ImageColor3 = SelectedTheme.Accent
			else
		...
		newNotification.Size = UDim2.new(1, -20, 0, 0)
		...
		local totalHeight = math.max(textBounds[1] + textBounds[2] + 45, 75)
		...
		TweenService:Create(newNotification.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {
			Transparency = 0
		}):Play()

		TweenService:Create(newNotification.Shadow, TweenInfo.new(0.4, Enum.EasingStyle.Quad), {
			ImageTransparency = 0.3
		}):Play()

		-- Staggered text appearance
		task.wait(0.1)
		TweenService:Create(newNotification.Title, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
			TextTransparency = 0
		}):Play()

		if newNotification.Icon.Visible then
			TweenService:Create(newNotification.Icon, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
				ImageTransparency = 0
			}):Play()
		end

		task.wait(0.1)
		TweenService:Create(newNotification.Description, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
			TextTransparency = 0.2
		}):Play()

		-- Auto-dismiss after duration
		local waitDuration = math.min(math.max((#newNotification.Description.Text * 0.08) + 3, 4), 12)
		task.wait(data.Duration or waitDuration)

		-- Smooth exit animation
		TweenService:Create(newNotification, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
			BackgroundTransparency = 1,
			Size = UDim2.new(1, -20, 0, 0)
		}):Play()

		TweenService:Create(newNotification.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
			Transparency = 1
		}):Play()

		TweenService:Create(newNotification.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
			ImageTransparency = 1
		}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.Theme then
		...
		if not success then
			local success, result2 = pcall(ChangeTheme, 'ModernDark')
			if not success then
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		TabButton.MouseEnter:Connect(function()
			if Elements.UIPageLayout.CurrentPage ~= TabPage then
				TweenService:Create(TabButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
					BackgroundColor3 = SelectedTheme.TabBackgroundHover
				}):Play()
			end
		end)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.Error}):Play()
			...
			Button.MouseEnter:Connect(function()
				...
				TweenService:Create(Button.UIStroke, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
					Color = SelectedTheme.Accent
				}):Play()
				TweenService:Create(Button.ElementIndicator, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					TweenService:Create(Input, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.Error}):Play()
			...
			local function SetDropdownOptions()
				for _, Option in ipairs(DropdownSettings.Options) do
					...
					DropdownOption.Interact.MouseButton1Click:Connect(function()
						...
						if not Success then
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.Error}):Play()
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			Keybind.MouseEnter:Connect(function()
				TweenService:Create(Keybind, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
					BackgroundColor3 = SelectedTheme.ElementBackgroundHover
				}):Play()
			end)
			...
			UserInputService.InputBegan:Connect(function(input, processed)
				...
				elseif not KeybindSettings.CallOnChange and KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.Error}):Play()
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.Switch.UIStroke.Thickness = 1

			-- Modern indicator
			Toggle.Switch.Indicator.Size = UDim2.new(0, 20, 0, 20)
			Toggle.Switch.Indicator.Position = ToggleSettings.CurrentValue and UDim2.new(1, -22, 0.5, 0) or UDim2.new(0, 2, 0.5, 0)
			
			if ToggleSettings.CurrentValue then
				Toggle.Switch.Indicator.BackgroundColor3 = SelectedTheme.ToggleEnabled
				Toggle.Switch.Indicator.UIStroke.Color = SelectedTheme.ToggleEnabledStroke
				Toggle.Switch.BackgroundColor3 = SelectedTheme.ToggleEnabled
				Toggle.Switch.BackgroundTransparency = 0.7
			else
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				if ToggleSettings.CurrentValue == true then
					...
					TweenService:Create(Toggle.Switch.Indicator, TweenInfo.new(0.45, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2.new(0, 2, 0.5, 0)}):Play()
					...
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
					TweenService:Create(Toggle.Switch.Indicator, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Position = UDim2.new(1, -22, 0.5, 0)}):Play()
				...
				if not Success then
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.Error}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Transparency = 1}):Play()
				...
				local Loop; Loop = RunService.Stepped:Connect(function()
					if SLDragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {BackgroundColor3 = SelectedTheme.Error}):Play()
